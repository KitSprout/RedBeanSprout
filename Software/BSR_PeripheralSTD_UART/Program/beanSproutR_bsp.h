...
#define LED_R_GPIO_CLK_ENABLE()   RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOC, ENABLE)
...
#define LED_G_GPIO_CLK_ENABLE()   RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOC, ENABLE)
...
#define LED_B_GPIO_CLK_ENABLE()   RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOC, ENABLE)
...
#define KEY_WU_GPIO_CLK_ENABLE()  RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA, ENABLE)
...
#define KEY_BO_GPIO_CLK_ENABLE()  RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB, ENABLE)
#define KEY_BO_Read()             (__GPIO_READ(KEY_BO_GPIO_PORT, KEY_BO_PIN) == KEY_BO_PIN)
/*====================================================================================================*/
/*====================================================================================================*/
typedef void (*pFunc)( void );

extern pFunc UART1_RecvEven;

void BSR_GPIO_Config( void );
void BSR_UART_Config( pFunc pUARTx );
/*====================================================================================================*/
/*====================================================================================================*/
#endif	 
