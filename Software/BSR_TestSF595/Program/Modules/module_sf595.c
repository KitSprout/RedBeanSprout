...
#define SF595_DI_GPIO_CLK   RCC_APB2Periph_GPIOA
...
#define SF595_OE_GPIO_CLK   RCC_APB2Periph_GPIOA
...
#define SF595_ST_GPIO_CLK   RCC_APB2Periph_GPIOA
...
#define SF595_SH_GPIO_CLK   RCC_APB2Periph_GPIOA
...
#define SF595_MR_GPIO_CLK   RCC_APB2Periph_GPIOA
...
void SF595_Config( void )
{
  ...
  /* GPIO Clk Init *************************************************************/
  RCC_APB2PeriphClockCmd(SF595_DI_GPIO_CLK, ENABLE);
  RCC_APB2PeriphClockCmd(SF595_OE_GPIO_CLK, ENABLE);
  RCC_APB2PeriphClockCmd(SF595_ST_GPIO_CLK, ENABLE);
  RCC_APB2PeriphClockCmd(SF595_SH_GPIO_CLK, ENABLE);
  RCC_APB2PeriphClockCmd(SF595_MR_GPIO_CLK, ENABLE);
