...
int8_t UART_RecvByteWTO( USART_TypeDef *USARTx, uint8_t *RecvData, int32_t TimeoutMs );
...
int8_t UART_RecvDataWTO( USART_TypeDef *USARTx, uint8_t *RecvData, uint16_t DataLen, int32_t TimeoutMs );
/*====================================================================================================*/
/*====================================================================================================*/
#endif	 
